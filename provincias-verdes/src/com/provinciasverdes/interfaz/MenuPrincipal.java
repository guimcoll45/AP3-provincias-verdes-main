        ...
        do {
            ...
            switch (opcion) {
                    ...
                    do {
                        ...
                        switch (opcUbi) {
                            case 1:
                                ...
                                break;
                            case 2:
                                System.out.print("Provincia: "); String prov = scanner.nextLine();
                                System.out.print("Dirección: "); String dir = scanner.nextLine();
                                System.out.print("Latitud: "); double lat = scanner.nextDouble();
                                System.out.print("Longitud: "); double lon = scanner.nextDouble();
                                scanner.nextLine();

                                Ubicacion nuevaUbi = new Ubicacion(0, usuarioLogueado.getId(), prov, dir, lat, lon);
                                if (ubiDao.crear(nuevaUbi)) System.out.println("✅ Ubicación guardada.");
                                else System.out.println("❌ Error al guardar.");
                                break;
                            case 3:
                                System.out.print("Ingrese ID: "); int idUbi = scanner.nextInt();
                                Ubicacion b = ubiDao.buscarPorId(idUbi);
                                if (b != null) System.out.println("✅ " + b.getProvincia() + ", " + b.getDireccion());
                    ...
                    do {
                        ...
                        switch (opcEq) {
                            ...
                            case 2:
                                ...
                                System.out.print("Tipo (Panel/Inversor): "); scanner.nextLine(); String tipo = scanner.nextLine();
                ...
                case 6:
                    ...
                    Reporte reporteFinal = generador.generarReporteEficiencia(datosReporte, periodo);
                    System.out.println("\n📄 REPORTE GENERADO:");
                    System.out.println("Título: " + reporteFinal.getTitulo());
                    System.out.println("Periodo: " + reporteFinal.getPeriodo());
                    System.out.println("Contenido:\n" + reporteFinal.getContenido());
                    break;
